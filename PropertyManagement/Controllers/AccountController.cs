    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Register()
        {
            using (var db = ApplicationDbContext.Create())
            {
                ...
                {
                    UserTypes = db.UserTypes.Where(m => !m.Name.ToLower().Equals(SD.AdminUserRole.ToLower())).ToList(),
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    using (var db = ApplicationDbContext.Create())
                    {
                        model.UserTypes = db.UserTypes.ToList();
                        var roleStore = new RoleStore<IdentityRole>(new ApplicationDbContext());
                        var roleManager = new RoleManager<IdentityRole>(roleStore);
                        var memebership = model.UserTypes.SingleOrDefault(m => m.Id == model.MembershipTypeId).Name.ToString();
